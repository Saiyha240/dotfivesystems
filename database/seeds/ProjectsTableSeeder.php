...
$projects = [
                        ['name' => 'Ball Club', 'details' => '', 'technology'=> 'HTML, CSS, JavaScript, PHP, Wordpress', 'image'=> asset('build/img/23.jpg'), 'url' => 'http://erwinvalencia.com', 'done_date'=> Carbon::now()->year = 2017, 'order' => 0],
                        ['name' => 'Eskwelaban', 'details' => '', 'technology'=> 'HTML, CSS, JavaScript, PHP, Wordpress', 'image'=> asset('build/img/24.jpg'), 'url' => 'http://tobaccofreedeped.org', 'done_date'=> Carbon::now()->year = 2017, 'order' => 0],
                        ['name' => 'xChange', 'details' => '', 'technology'=> 'HTML, CSS, JavaScript, PHP, Wordpress', 'image'=> asset('build/img/22.jpg'), 'url' => 'http://xchange.ph', 'done_date'=> Carbon::now()->year = 2017, 'order' => 0],
                        ['name' => 'Visions of Hope Foundation', 'details' => '', 'technology'=> 'HTML, CSS, JavaScript, PHP, Wordpress', 'image'=> asset('build/img/25.jpg'), 'url' => 'http://www.visionsofhopefoundation.org', 'done_date'=> Carbon::now()->year = 2017, 'order' => 0],
                        ...
                        ['name' => 'Penalosa Farms', 'details' => '', 'technology'=> 'HTML, CSS, JavaScript, PHP, Wordpress', 'image'=> asset('build/img/26.jpg'), 'url' => 'http://penalosafarms.com', 'done_date'=> Carbon::now()->year = 2016, 'order' => 0],
                        ['name' => 'Kapayapaan', 'details' => '', 'technology'=> 'HTML, CSS, JavaScript, PHP, Wordpress', 'image'=> asset('build/img/27.jpg'), 'url' => 'http://kapayapaan.org', 'done_date'=> Carbon::now()->year = 2016, 'order' => 0],
                        ['name' => 'Valleys Best HH', 'details' => '', 'technology'=> 'HTML, CSS, JavaScript, PHP, Wordpress', 'image'=> asset('build/img/28.jpg'), 'url' => 'http://valleysbesthh.com', 'done_date'=> Carbon::now()->year = 2016, 'order' => 0],
