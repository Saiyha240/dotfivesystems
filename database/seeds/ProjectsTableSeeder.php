...
class ProjectsTableSeeder extends Seeder {
	...
	public function run() {
		...
		$projects = [
			['name' => 'BloggedinAsean', 'details' => '', 'technology'=> 'HTML, CSS, JavaScript, PHP, Wordpress, Laravel', 'image'=> asset('build/img/10.jpg'), 'url' => 'http://bloggedinasean.com', 'done_date'=> Carbon::now()->year = 2014, 'order' => 0],
